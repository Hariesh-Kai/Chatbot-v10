...
## Ingestion formats (current baseline)

- PDF, DOCX, XLSX, CSV, TXT, MD, HTML, XML.
- Scanned/image-only PDFs are not OCRed in this baseline and will return a clear error message.
